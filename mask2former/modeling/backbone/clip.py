...
from .clip_attention import ClipStageAdapterV1, ClipStageAdapterV2
...
class CLIP(Backbone):
    def __init__(self, cfg, input_shape):
        ...
        for i in range(4):
            self.stage_adapter_layers.append(
                    ClipStageAdapterV1(visual_dim=self.output_channels[i + 1],
    ...
    def get_text_classifier(self, text_list, device):
        # self.eval()
        with torch.no_grad():
            # reference for templates: https://github.com/mlfoundations/open_clip/blob/
            # 91f6cce16b7bee90b3b5d38ca305b5b3b67cc200/src/training/imagenet_zeroshot_data.py
